                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/azure/machine-learning/preview">Machine Learning サービス</a></li>
                                                ...
                                                <ul class="noBullet">
                                                    <li>
                                                        <a class="barLink" href="https://docs.microsoft.com/vsts/deploy-azure/">
                                                            <img src="https://docs.microsoft.com/media/logos/logo_vs-team-services.svg" alt=""> Azure へのデプロイ</a>
                                                    </li>
                                                    <li>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>
HTTP 負荷分散と配信管理機能が組み込まれたレイヤー 7 ロード バランサー </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>お客様のアプリケーションを分散型サービス拒否 (DDoS) 攻撃から保護</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Blob Storage</h3>
                                                    <p>高度なスケーラビリティを備えた非構造化データ用オブジェクト ストレージ</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>File Storage</h3>
                                                    <p>シンプルな分散型のクロスプラットフォーム ファイル システム</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Site Recovery</h3>
                                                    <p>Azure VM、オンプレミス VM、物理サーバーのディザスター リカバリーを調整</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>完全対話式で魅力的なデータの視覚エフェクトをアプリケーションに組み込む</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            ...
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/speaker-recognition/home"><img src="media/index/API_Speaker_Recognition.svg" alt="" /><span>Speaker Recognition&nbsp;<sup style="font-size:70%">プレビュー</sup></span></a>
                                                            </li>
                                                            <li>
                                                ...
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            ...
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/web-language-model/home"><img src="media/index/API_WebLanguageModel.svg" alt="" /><span>Web Language Model&nbsp;<sup style="font-size:70%">プレビュー</sup></span></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            ...
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/entitylinking/home"><img src="media/index/API_Entity_LinkingIntelligence.svg" alt="" /><span>Entity Linking&nbsp;<sup style="font-size:70%">プレビュー</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/kes/overview"><img src="media/index/API_KnowledgeExploration.svg" alt="" /><span>Knowledge Exploration Service (KES)&nbsp;<sup style="font-size:70%">プレビュー</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/qnamaker/home"><img src="media/index/API_QnAMaker.svg" alt="" /><span>QnAMaker&nbsp;<sup style="font-size:70%">プレビュー</sup></span></a>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/academic-knowledge/home"><img src="media/index/API_Know_Academic.svg" alt="" /><span>Academic Knowledge&nbsp;<sup style="font-size:70%">プレビュー</sup></span></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Azure IoT Hub へのゼロタッチでジャストインタイムなプロビジョニング</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>お客様に影響を及ぼす Azure サービスの問題に関し、パーソナライズされたガイダンスとサポートを提供。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://www.visualstudio.com/vs/azure-tools/">ダウンロード</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://docs.microsoft.com/visualstudio/python/python-in-visual-studio">Visual Studio を使ってみる</a>
                                                </p>
                                                <p>
                                                    <a href="https://code.visualstudio.com/docs/languages/python">Visual Studio Code を使ってみる</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
